---
name: tech-research
description: Research agent that finds optimal libraries, tools, or techniques for project needs
model_type: thinking
directory_access: ["reports/", "docs/", "features/"]
read_only: false
tool_restrictions: ["src/", "*.ts", "*.js"]
recommended_models: ["o1-pro", "o1", "claude-3-5-sonnet-20241022", "deepseek-r1"]
---
